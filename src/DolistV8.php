...
class DolistV8
{
    ...
    public function saveContact(Contact $contact)
    {
        ...
        return $this->send(self::WSDL_CONTACT, self::SOAP_CONTACT, 'SaveContact', $options);
    }
    ...
    public function getDetailsContact($culture, $offset, $email, $memberId, $returnFields)
    {
        ...
        return $this->send(self::WSDL_CONTACT, self::SOAP_CONTACT, 'GetContact', $options);
    }
    ...
    public function createSegment(Segment $segment)
    {
        ...
        return $this->send(self::WSDL_SEG, self::SOAP_SEG, 'CreateSegment', $options);
    }
    ...
    public function createSegmentTest($emails)
    {
        ...
        return $this->send(self::WSDL_SEG, self::SOAP_SEG, 'CreateSegmentTest', $options);
    }
    ...
    public function deleteSegment(Segment $segment)
    {
        ...
        return $this->send(self::WSDL_SEG, self::SOAP_SEG, 'DeleteSegment', $options);
    }
    ...
    public function getAllSegments()
    {
        ...
        return $this->send(self::WSDL_SEG, self::SOAP_SEG, 'GetAllSegments', array('token' => $this->token));
    }
    ...
    public function createCampaign(Campaign $campaign)
    {
        ...
        return $this->send(self::WSDL_CAM, self::SOAP_CAM, 'CreateCampaign', $options);
    }
    ...
    public function sendCampaignTest(Campaign $campaign, Segment $segment)
    {
        ...
        return $this->send(self::WSDL_CAM, self::SOAP_CAM, 'SendCampaignTest', $options);
    }
    ...
    public function sendCampaign(Campaign $campaign, Segment $segment, $planning, $period, $volume)
    {
        ...
        return $this->send(self::WSDL_CAM, self::SOAP_CAM, 'SendCampaign', $options);
    }
    ...
    public function cancelCampaign(Campaign $campaign)
    {
        ...
        return $this->send(self::WSDL_CAM, self::SOAP_CAM, 'CancelCampaign', $options);
    }
    ...
    public function getCampaignsById($date, $last, $offset)
    {
        ...
        return $this->send(self::WSDL_CAM, self::SOAP_CAM, 'GetCampaignsID', $options);
    }
